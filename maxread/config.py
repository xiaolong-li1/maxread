...
class Settings:
    ...
    def load(cls, root: Path | None = None) -> "Settings":
        ...
        return cls(
            ...
            sectional_generation_workers=max(1, int(os.environ.get("MAXREAD_SECTIONAL_GENERATION_WORKERS", "2"))),
            ...
            visual_qa_repair_rounds=max(0, int(os.environ.get("MAXREAD_VISUAL_QA_REPAIR_ROUNDS", "2"))),
